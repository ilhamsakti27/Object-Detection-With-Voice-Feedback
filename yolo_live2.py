...
# Load Video
# cap = cv2.VideoCapture("picture/video.mp4") #0 -> Webcam; "/path"
...
while True:
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            # cv2.putText(frame, label, (x, y+30), font, 1, color, 2) # hanya nama objek
            speak(label)
            cv2.putText(frame, label + " " + str(round(confidence, 2)), (x, y + 30), font, 1, color,
                        2)  # nama objek dan presentase keakuratan
